...
var len__40774__auto___52426 = arguments.length;
var i__40775__auto___52427 = (0);
while(true){
if((i__40775__auto___52427 < len__40774__auto___52426)){
args__40781__auto__.push((arguments[i__40775__auto___52427]));

var G__52428 = (i__40775__auto___52427 + (1));
i__40775__auto___52427 = G__52428;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__40782__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52423){
var G__52424 = cljs.core.first.call(null,seq52423);
var seq52423__$1 = cljs.core.next.call(null,seq52423);
var G__52425 = cljs.core.first.call(null,seq52423__$1);
var seq52423__$2 = cljs.core.next.call(null,seq52423__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__52424,G__52425,seq52423__$2);
});
...
if(cljs.core.truth_((function (){var or__39610__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__40235__auto__,writer__40236__auto__,opt__40237__auto__){
return cljs.core._write.call(null,writer__40236__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__39598__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__39598__auto__){
var or__39610__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52429_SHARP_){
return !((cljs.core.meta.call(null,p1__52429_SHARP_) == null));
})))){
...
var map__52430 = opts;
var map__52430__$1 = ((((!((map__52430 == null)))?((((map__52430.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52430.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52430):map__52430);
var markup_db = cljs.core.get.call(null,map__52430__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__39610__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e52434){var _e__51446__auto__ = e52434;
return false;
}})();
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
...
}catch (e52436){var _e__51446__auto__ = e52436;
return false;
}}
})())){
...
var _STAR_current_state_STAR_52438 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__52439 = opts;
var map__52439__$1 = ((((!((map__52439 == null)))?((((map__52439.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52439.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52439):map__52439);
var markup_db = cljs.core.get.call(null,map__52439__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_52438;
}});
...
;
var temp__4655__auto___52443 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___52443)){
var managed_print_level_52444 = temp__4655__auto___52443;
var _STAR_print_level_STAR_52442_52445 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_52444;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_52442_52445,managed_print_level_52444,temp__4655__auto___52443,writer,opts,job_fn){
return (function (p1__52441_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__52441_SHARP_,null);
});})(_STAR_print_level_STAR_52442_52445,managed_print_level_52444,temp__4655__auto___52443,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_52442_52445;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502732699063
