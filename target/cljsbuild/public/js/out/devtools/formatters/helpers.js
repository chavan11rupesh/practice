...
var G__52397 = devtools.prefs.pref.call(null,v);
v = G__52397;
continue;
} else {
return v;
...
var and__39598__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__39598__auto__){
var and__39598__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__39610__auto__ = (function (){try{if(!((value == null))){
...
}catch (e52400){var _e__51446__auto__ = e52400;
return false;
}})();
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
var or__39610__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e52404){var _e__51446__auto__ = e52404;
return false;
}})();
...
}catch (e52406){var _e__51446__auto__ = e52406;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__39598__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__39598__auto__)){
var and__39598__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__39598__auto____$1){
...
var and__39598__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__39598__auto__)){
...
var or__39610__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
...
var and__39598__auto__ = (function (){var or__39610__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
...
var vec__52408 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__52408,(0),null);
var name = cljs.core.nth.call(null,vec__52408,(1),null);
...
var and__39598__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__39598__auto__)){
...
var or__39610__auto__ = typeof value === 'string';
if(or__39610__auto__){
return or__39610__auto__;
} else {
var or__39610__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__52411_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__52411_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1502732698678
