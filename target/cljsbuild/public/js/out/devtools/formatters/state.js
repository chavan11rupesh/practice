...
var len__40774__auto___52417 = arguments.length;
var i__40775__auto___52418 = (0);
while(true){
if((i__40775__auto___52418 < len__40774__auto___52417)){
args__40781__auto__.push((arguments[i__40775__auto___52418]));

var G__52419 = (i__40775__auto___52418 + (1));
i__40775__auto___52418 = G__52419;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40782__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq52415){
var G__52416 = cljs.core.first.call(null,seq52415);
var seq52415__$1 = cljs.core.next.call(null,seq52415);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__52416,seq52415__$1);
});
...
return (p1__52420_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1502732698710
