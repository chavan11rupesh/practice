...
var or__39610__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj49177 = {"detail":data};
return obj49177;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__39598__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__39598__auto__)){
var and__39598__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__49184 = cljs.core._EQ_;
var expr__49185 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49184.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49185))){
return ((function (pred__49184,expr__49185){
return (function (p1__49178_SHARP_){
return console.warn(p1__49178_SHARP_);
});
;})(pred__49184,expr__49185))
} else {
if(cljs.core.truth_(pred__49184.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49185))){
return ((function (pred__49184,expr__49185){
return (function (p1__49179_SHARP_){
return console.debug(p1__49179_SHARP_);
});
;})(pred__49184,expr__49185))
} else {
if(cljs.core.truth_(pred__49184.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49185))){
return ((function (pred__49184,expr__49185){
return (function (p1__49180_SHARP_){
return console.error(p1__49180_SHARP_);
});
;})(pred__49184,expr__49185))
} else {
return ((function (pred__49184,expr__49185){
return (function (p1__49181_SHARP_){
return console.log(p1__49181_SHARP_);
});
;})(pred__49184,expr__49185))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49188){
var map__49189 = p__49188;
var map__49189__$1 = ((((!((map__49189 == null)))?((((map__49189.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49189.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49189):map__49189);
var opts = map__49189__$1;
var eval_fn = cljs.core.get.call(null,map__49189__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49191_SHARP_);
});})(new_def))
);
...
return (function (p__49192){
var vec__49193 = p__49192;
var ky = cljs.core.nth.call(null,vec__49193,(0),null);
var v = cljs.core.nth.call(null,vec__49193,(1),null);
...
if(cljs.core.truth_((function (){var and__39598__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502732693661
