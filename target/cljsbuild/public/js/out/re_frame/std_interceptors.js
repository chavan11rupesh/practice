...
var vec__44176_44179 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_44180 = cljs.core.nth.call(null,vec__44176_44179,(0),null);
var only_after_44181 = cljs.core.nth.call(null,vec__44176_44179,(1),null);
var db_changed_QMARK__44182 = (!((only_before_44180 == null))) || (!((only_after_44181 == null)));
if(db_changed_QMARK__44182){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_44180);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_44181);
...
var map__44183 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__44183__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__44183__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__44185 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__44185__$1 = ((((!((map__44185 == null)))?((((map__44185.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44185.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44185):map__44185);
var coeffects = map__44185__$1;
var event = cljs.core.get.call(null,map__44185__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__40774__auto___44188 = arguments.length;
var i__40775__auto___44189 = (0);
while(true){
if((i__40775__auto___44189 < len__40774__auto___44188)){
args__40781__auto__.push((arguments[i__40775__auto___44189]));

var G__44190 = (i__40775__auto___44189 + (1));
i__40775__auto___44189 = G__44190;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__40782__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq44187){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq44187));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__39610__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__40781__auto__ = [];
var len__40774__auto___44196 = arguments.length;
var i__40775__auto___44197 = (0);
while(true){
if((i__40775__auto___44197 < len__40774__auto___44196)){
args__40781__auto__.push((arguments[i__40775__auto___44197]));

var G__44198 = (i__40775__auto___44197 + (1));
i__40775__auto___44197 = G__44198;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__40782__auto__);
});
...
return (function (p1__44191_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__44191_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__44192_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__44192_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq44193){
var G__44194 = cljs.core.first.call(null,seq44193);
var seq44193__$1 = cljs.core.next.call(null,seq44193);
var G__44195 = cljs.core.first.call(null,seq44193__$1);
var seq44193__$2 = cljs.core.next.call(null,seq44193__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__44194,G__44195,seq44193__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1502732685758
