...
struct.core.dissoc_in = (function struct$core$dissoc_in(m,p__53058){
var vec__53059 = p__53058;
var seq__53060 = cljs.core.seq.call(null,vec__53059);
var first__53061 = cljs.core.first.call(null,seq__53060);
var seq__53060__$1 = cljs.core.next.call(null,seq__53060);
var k = first__53061;
var ks = seq__53060__$1;
var keys = vec__53059;
if(ks){
...
return cljs.core.reduce.call(null,(function (p1__53062_SHARP_,p2__53063_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__53062_SHARP_,struct.core.build_step.call(null,key,p2__53063_SHARP_));
}),acc,value);
} else {
return cljs.core.conj_BANG_.call(null,acc,struct.core.build_step.call(null,key,value));
}
});
struct.core.normalize_step_entry = (function struct$core$normalize_step_entry(acc,p__53066){
...
var key = first__53069;
var values = seq__53068__$1;
return cljs.core.reduce.call(null,((function (vec__53067,seq__53068,first__53069,seq__53068__$1,key,values){
return (function (p1__53064_SHARP_,p2__53065_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__53064_SHARP_,struct.core.build_step.call(null,key,p2__53065_SHARP_));
});})(vec__53067,seq__53068,first__53069,seq__53068__$1,key,values))
,acc,values);
});
...
var G__53070 = skip;
var G__53071 = errors;
var G__53072 = data__$1;
var G__53073 = cljs.core.rest.call(null,steps__$1);
skip = G__53070;
errors = G__53071;
data__$1 = G__53072;
steps__$1 = G__53073;
...
if(cljs.core.truth_((function (){var and__39598__auto__ = (value == null);
...
var G__53074 = skip;
var G__53075 = errors;
var G__53076 = data__$1;
var G__53077 = cljs.core.rest.call(null,steps__$1);
skip = G__53074;
errors = G__53075;
data__$1 = G__53076;
steps__$1 = G__53077;
...
var G__53078 = skip;
var G__53079 = errors;
var G__53080 = cljs.core.assoc_in.call(null,data__$1,path,value__$1);
var G__53081 = cljs.core.rest.call(null,steps__$1);
skip = G__53078;
errors = G__53079;
data__$1 = G__53080;
steps__$1 = G__53081;
...
var G__53082 = cljs.core.conj.call(null,skip,path);
var G__53083 = cljs.core.assoc_in.call(null,errors,path,message);
var G__53084 = struct.core.dissoc_in.call(null,data__$1,path);
var G__53085 = cljs.core.rest.call(null,steps__$1);
skip = G__53082;
errors = G__53083;
data__$1 = G__53084;
steps__$1 = G__53085;
...
struct.core.validate.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__53088){
...
var opts = map__53089__$1;
var strip = cljs.core.get.call(null,map__53089__$1,new cljs.core.Keyword(null,"strip","strip",632627960),false);
...
struct.core.validate_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__53097){
...
var message = cljs.core.get.call(null,map__53098__$1,new cljs.core.Keyword(null,"message","message",-406056002),"Schema validation error");
var vec__53100 = struct.core.validate.call(null,data,schema,opts);
var errors = cljs.core.nth.call(null,vec__53100,(0),null);
var data__$1 = cljs.core.nth.call(null,vec__53100,(1),null);
...
struct.core.uuid = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53105_SHARP_){
return (p1__53105_SHARP_ instanceof cljs.core.UUID);
})], null);
struct.core._PLUS_uuid_re_PLUS_ = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;
struct.core.uuid_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53106_SHARP_){
var and__39598__auto__ = typeof p1__53106_SHARP_ === 'string';
if(and__39598__auto__){
return cljs.core.re_seq.call(null,/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/,p1__53106_SHARP_);
} else {
return and__39598__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__53108_SHARP_){
return struct.core.uuid.call(null,p1__53108_SHARP_);
})], null);
...
var and__39598__auto__ = typeof p1__53109_SHARP_ === 'string';
if(and__39598__auto__){
return cljs.core.re_seq.call(null,rx,p1__53109_SHARP_);
} else {
return and__39598__auto__;
}
});})(rx))
...
struct.core.required = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"this field is mandatory",new cljs.core.Keyword(null,"optional","optional",2053951509),false,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53110_SHARP_){
if(typeof p1__53110_SHARP_ === 'string'){
return !(cljs.core.empty_QMARK_.call(null,p1__53110_SHARP_));
} else {
return !((p1__53110_SHARP_ == null));
}
})], null);
...
struct.core.number_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a number",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53111_SHARP_){
var and__39598__auto__ = typeof p1__53111_SHARP_ === 'string';
if(and__39598__auto__){
return cljs.core.re_seq.call(null,/^[-+]?[0-9]*\.?[0-9]+$/,p1__53111_SHARP_);
} else {
return and__39598__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__53112_SHARP_){
return parseFloat(p1__53112_SHARP_);
})], null);
...
var and__39598__auto__ = typeof v === 'string';
if(and__39598__auto__){
...
struct.core.boolean$ = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a boolean",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53114_SHARP_){
return (cljs.core._EQ_.call(null,false,p1__53114_SHARP_)) || (cljs.core._EQ_.call(null,true,p1__53114_SHARP_));
})], null);
...
struct.core.every = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must match the predicate",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53116_SHARP_,p2__53115_SHARP_){
return cljs.core.every_QMARK_.call(null,p2__53115_SHARP_,p1__53116_SHARP_);
})], null);
struct.core.member = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"not in coll",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__53117_SHARP_,p2__53118_SHARP_){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p1__53117_SHARP_]),p2__53118_SHARP_);
})], null);
...
//# sourceMappingURL=core.js.map?rel=1502732703117
