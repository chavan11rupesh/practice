...
var len__40774__auto___42831 = arguments.length;
var i__40775__auto___42832 = (0);
while(true){
if((i__40775__auto___42832 < len__40774__auto___42831)){
args__40781__auto__.push((arguments[i__40775__auto___42832]));

var G__42833 = (i__40775__auto___42832 + (1));
i__40775__auto___42832 = G__42833;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__40782__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq42830){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42830));
});
...
var G__42836 = cljs.core.reduce.call(null,((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return (function (p1__42834_SHARP_){
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__42834_SHARP_,p1__42834_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__42837 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__4655__auto__){
return (function (p1__42835_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__42835_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__42836;
state = G__42837;
...
var vec__42840 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__42843 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__42843,(0),null);
var new_state = cljs.core.nth.call(null,vec__42843,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__42840,(0),null);
var new_state = cljs.core.nth.call(null,vec__42840,(1),null);
var G__42847 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__42848 = cljs.core.PersistentVector.EMPTY;
var G__42849 = cljs.core.rest.call(null,tokens);
var G__42850 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__42847;
buf = G__42848;
tokens = G__42849;
cur_state = G__42850;
...
var G__42851 = out;
var G__42852 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__42853 = cljs.core.rest.call(null,tokens);
var G__42854 = cur_state;
out = G__42851;
buf = G__42852;
tokens = G__42853;
cur_state = G__42854;
...
var G__42855 = out;
var G__42856 = buf;
var G__42857 = cljs.core.rest.call(null,tokens);
var G__42858 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__42855;
buf = G__42856;
tokens = G__42857;
cur_state = G__42858;
...
var G__42859 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__42860 = buf;
var G__42861 = cljs.core.rest.call(null,tokens);
var G__42862 = cur_state;
out = G__42859;
buf = G__42860;
tokens = G__42861;
cur_state = G__42862;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__42863_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__42863_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__42864_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__42864_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__42864_SHARP_));
...
//# sourceMappingURL=common.js.map?rel=1502732682180
