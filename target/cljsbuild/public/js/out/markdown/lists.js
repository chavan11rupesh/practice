...
return clojure.string.join.call(null,(function (){var iter__40413__auto__ = (function markdown$lists$close_lists_$_iter__42978(s__42979){
return (new cljs.core.LazySeq(null,(function (){
var s__42979__$1 = s__42979;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__42979__$1);
if(temp__4657__auto__){
var s__42979__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__42979__$2)){
var c__40411__auto__ = cljs.core.chunk_first.call(null,s__42979__$2);
var size__40412__auto__ = cljs.core.count.call(null,c__40411__auto__);
var b__42981 = cljs.core.chunk_buffer.call(null,size__40412__auto__);
if((function (){var i__42980 = (0);
while(true){
if((i__42980 < size__40412__auto__)){
var vec__42982 = cljs.core._nth.call(null,c__40411__auto__,i__42980);
var list_type = cljs.core.nth.call(null,vec__42982,(0),null);
cljs.core.chunk_append.call(null,b__42981,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("</li></"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(">")].join(''));

var G__42988 = (i__42980 + (1));
i__42980 = G__42988;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42981),markdown$lists$close_lists_$_iter__42978.call(null,cljs.core.chunk_rest.call(null,s__42979__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__42981),null);
}
} else {
var vec__42985 = cljs.core.first.call(null,s__42979__$2);
var list_type = cljs.core.nth.call(null,vec__42985,(0),null);
return cljs.core.cons.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("</li></"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(">")].join(''),markdown$lists$close_lists_$_iter__42978.call(null,cljs.core.rest.call(null,s__42979__$2)));
}
} else {
return null;
}
...
return iter__40413__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__42989_SHARP_){
return (cljs.core.second.call(null,p1__42989_SHARP_) > num_indents);
...
var vec__42990 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__42990,(0),null);
var indents = cljs.core.nth.call(null,vec__42990,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__39610__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__42993 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__42993,(0),null);
var indents = cljs.core.nth.call(null,vec__42993,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__39610__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__42996){
var map__42997 = p__42996;
var map__42997__$1 = ((((!((map__42997 == null)))?((((map__42997.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42997.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42997):map__42997);
var state = map__42997__$1;
var code = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__42997__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__39598__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__39598__auto__ = lists;
if(cljs.core.truth_(and__39598__auto__)){
var or__39610__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
return eof;
...
var and__39598__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__39598__auto__ = (function (){var or__39610__auto__ = eof;
if(cljs.core.truth_(or__39610__auto__)){
return or__39610__auto__;
} else {
...
//# sourceMappingURL=lists.js.map?rel=1502732682598
